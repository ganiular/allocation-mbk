                ...
                <form method="post" id="reg-form">
                  <div class="box-body">
                    ...
                    <a href="#examroom" data-target="#examroom" data-toggle="modal" class="dropdown-toggle pull-right">
                      ...
                      <button class="btn btn-primary">Exam Hall</button>
                    </a>
                    ...
                    <span style="font-size:18px;font-weight:bolder" class="pull-right">Print Exam Timetable &nbsp;</span>
                    <br><br>
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="height:auto">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span></button>
          <h4 class="modal-title">Search Level Exam Timetable</h4>
        </div>
        <div class="modal-body">
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="height:auto">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span></button>
          <h4 class="modal-title">Search Hall Exam Schedule</h4>
        </div>
        <div class="modal-body">
