...
include('../dist/includes/dbcon.php');
	...
	foreach ($first as $daym){
		...
		{
			mysqli_query($con,"INSERT INTO exam_sched(date,time_id,day,member_id,subject_code,cys,cys1,room,remarks,settings_id,term,encoded_by) 
				VALUES('$doe','$daym','first','$member','$subject','$cys','$cys1','$room','$remarks','$set_id','$term','$id')")or die(mysqli_error());
	...
	foreach ($second as $daym){
		...
		{
			mysqli_query($con,"INSERT INTO exam_sched(date,time_id,day,member_id,subject_code,cys,cys1,room,remarks,settings_id,term,encoded_by) 
				VALUES('$doe','$daym','second','$member','$subject','$cys','$cys1','$room','$remarks','$set_id','$term','$id')")or die(mysqli_error());
	...
	foreach ($third as $daym){
		...
		{
			mysqli_query($con,"INSERT INTO exam_sched(date,time_id,day,member_id,subject_code,cys,cys1,room,remarks,settings_id,term,encoded_by) 
				VALUES('$doe','$daym','third','$member','$subject','$cys','$cys1','$room','$remarks','$set_id','$term','$id')")or die(mysqli_error());
