...
<html>
  <head>
    ...
    <title>Level | <?php include('../dist/includes/title.php');?></title>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    ?>
                <tr>
                <td>Hall <?php echo $Hall;?></td>
                 
                <td><a id="click" href="room.php?id=<?php echo $id;?>&room=<?php echo $Hall;?>">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Add Hall</label><br>
								<input type="text" class="form-control" name="Hall" placeholder="Hall" required>
				...
				<div class="box-body" style="" id="displayform">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Update Level</label><br>
								<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $_REQUEST['id'];?>" placeholder="Room ID" readonly>
								<input type="text" class="form-control" id="class" name="Hall" value="<?php echo $_REQUEST['room'];?>" placeholder="Hall" required>
						  </div><!-- /.form group -->
					</div>
				  </div>	
