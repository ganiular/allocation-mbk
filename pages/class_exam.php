...
<body>
	...
	<div class="wrapper_print">
		...
		<img src="../dist/img/LOGO.jpg" width="60px" height="60px" class="logo">
		<img src="../dist/img/CIT.jpg" width="60px" height="60px" class="logo2" style="display:hidden">
		<h5 align="center">

			KWARA STATE UNIVERSITY</br>
			FACULTY OF INFORMATION AND COMMUNICATION TECHNOLOGY</br><br><br>
			LEVEL <?php echo strtoupper($rows['term']); ?> EXAM TIMETABLE</br>
		</h5>
		<h5 align="center">
			Level: &nbsp; <font color="blue"><?php echo $class;  ?></font>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Section:&nbsp;
			<?php echo $rows['sy']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table style="width:100%;float:left">
			...
			?>
				<tr class="show">
					...
					<td><?php echo $row1['date'].' ('. $row1['day'].')'; ?> day</td>
